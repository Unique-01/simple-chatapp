...
from chatrealtime.settings import DEBUG
...
def room(request,room_name):
    ...
    return render(request,'room.html',{'room_name':room_name,'room_message':room_message,'room':room,'chat_room':chat_room,'debug':DEBUG})
